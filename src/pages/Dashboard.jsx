      ...
      <div className="flex min-h-screen bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-100">
        <main className="flex-1 p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
            <div className="bg-white rounded-xl p-6 hover:-translate-y-1 hover:shadow-xl transition duration-300 dark:bg-gray-900">
            ...
            <div className="bg-white rounded-xl p-6 hover:-translate-y-1 hover:shadow-xl transition duration-300 dark:bg-gray-900">
              ...
              <div className="w-full h-2 bg-gray-200 rounded-full mt-5 dark:bg-gray-700">
                <div
              ...
              {recentTasks.length === 0 ? (
                ...
                <div className="space-y-4">
                  {recentTasks.map((task) => (
                    <div
                      key={task.id}
                      className="flex items-center justify-between bg-gray-50 rounded-lg p-4 dark:bg-gray-800"
                    >
                      <div>
              ...
              {upcomingTasks.length === 0 ? (
                ...
                <div className="space-y-4">
                  {upcomingTasks.map((task) => (
                    <div
                      key={task.id}
                      className="flex justify-between items-center border-b border-gray-200 pb-3 dark:border-slate-700"
                    >
                      <div>
                        <h3 className="font-semibold">{task.title}</h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="mt-8 bg-white rounded-xl p-6 text-center dark:bg-gray-900">
